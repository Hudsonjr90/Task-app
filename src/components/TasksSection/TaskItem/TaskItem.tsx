    ...
    <>
      <li key={task.id}>
        <Link
          to={`/dir/${task.dir}`}
          title={task.dir}
          className="ml-auto mr-4 w-min whitespace-nowrap overflow-hidden max-w-[10rem] text-center text-ellipsis bg-green-800 text-blue-300 px-4 py-1 rounded-t-md transition dark:bg-slate-700 dark:text-slate-200 block hover:bg-green-800 dark:hover:bg-green-800"
        >
          {task.dir}
        </Link>
        <article
